...
char *AssociarAssinatura(
            ...
            char    *assinatura)
{
    return _resposta_padrao(sessao, 13000, "Assinatura do AC registrada");
}
...
char *ComunicarCertificadoICPBRASIL(
            ...
            char    *certificado)
{
    return _resposta_padrao(sessao, 05000,
...
{
    static char resp[512];
    sprintf(resp, "%d|%05d|%s||%s", sessao, 10000,
                                    "Resposta com sucesso", STATUS_SAT);
    return resp;
}
...
{
    static char resp[256];
    sprintf(resp, "%d|%05d|%s|||%s", sessao, 15000,
                                     "Transf\xc3\xaarencia completa",
                                     "QXJxdWl2byBkZSBMb2c=");
    return resp;
}
